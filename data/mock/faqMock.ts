...
bactericidas, reduciendo la necesidad de productos químicos. Previene tanto como combate.
    • Transductor ultrasónico: Emite ondas ultrasónicas que previenen la formación de algas y biofilm en las superficies de la piscina, y con ello el crecimiento de colonias de organismos
alojados en rincones y cañerías.

Estos sistemas se activan automáticamente cuando el filtro está en modo "Filtrar" o "Recircular", pero se desactivan en los modos "Retrolavar" y "Desagotar" para proteger los equipos.`
};

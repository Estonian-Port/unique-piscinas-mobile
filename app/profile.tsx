    ...
    <ScrollView className="bg-white">
      <Screen>
        ...
        <View className='w-11/12 items-center justify-between'>
          ...
          <TextInput className='border w-3/5 h-10 rounded-lg mt-2 px-2' placeholder={user.name}/>
          <Text className='mt-4 font-geist text-text text-base'>Apellido</Text>
          <TextInput className='border w-3/5 h-10 rounded-lg mt-2 px-2' placeholder={user.lastname}/>
          <Text className='mt-4 font-geist text-text text-base'>Email</Text>
          <TextInput className='border w-3/5 h-10 rounded-lg mt-2 px-2' placeholder={user.email}/>
          <Link asChild href={'/changePass'}>
          <Pressable className='mt-6 rounded-lg bg-red-400 p-4 w-3/5'>
            <Text className='font-geist-semiBold text-text text-lg text-center'>Cambiar contraseña</Text>
          </Pressable>
          </Link>
          <Pressable className='mt-6 rounded-lg bg-gray-400 p-4 w-3/5'>
            <Text className='font-geist-semiBold text-text text-lg text-center'>Guardar cambios</Text>
          </Pressable>
          <Pressable className='flex-row items-center justify-center mt-10 rounded-lg p-4 w-3/5'>
            <LogoutIcon color='#9ca3af'/>
            <Text className='ml-2 font-geist-semiBold text-gray-400 text-lg text-center'>Cerrar sesión</Text>
          </Pressable>
          </View>

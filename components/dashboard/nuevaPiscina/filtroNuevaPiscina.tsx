...
import { Bomba, Filtro, PiscinaNueva } from '@/data/domain/piscina';
...
const validationSchema = Yup.object().shape({
  ...
  datoExtra: Yup.string().notRequired(),
});
    ...
    >
      ...
      <DropDownPicker
        ...
        setValue={(callback) => {
          ...
          setFieldTouched('marcaFiltro', true);
        }}
      ...
      <DropDownPicker
        ...
        setValue={(callback) => {
          ...
          setFieldTouched('modeloFiltro', true);
        }}
